...
if index(drug_name,'OFLOXACIN')>0 and index(drug_name,'LEVO')=0 and index(drug_name,'CIPRO')=0 /*so it doesn't overwrite Levofloxacin and ciprofloxacin*/
 and route=2 then drug='Ofloxacin';
...
else if med_route in ('Ofloxacin_PO', 'Ofloxacin_IV', 'Ciprofloxacin_IV','Levofloxacin_IV', 'Ciprofloxacin_PO','Levofloxacin_PO',
